...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var characters:Array<String> = CoolUtil.coolTextFile(Paths.getPath('characterList.txt'));
		var gfVersions:Array<String> = CoolUtil.coolTextFile(Paths.getPath('gfVersionList.txt'));
		var stages:Array<String> = CoolUtil.coolTextFile(Paths.getPath('stageList.txt'));
		var noteStyles:Array<String> = CoolUtil.coolTextFile(Paths.getPath('noteStyleList.txt'));
